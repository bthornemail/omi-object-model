#!/usr/bin/env python3
"""Verify OMI authority boundaries are correct."""
import os
...
def check_core_sentences():
    sentences = ["OMI defines", "SETCO classifies", "Projection is not authority"]
    found = {}
...
def main():
    ...
    missing = [s for s in ["OMI defines", "SETCO classifies", "Projection is not authority"] if s not in found]
    if missing:
